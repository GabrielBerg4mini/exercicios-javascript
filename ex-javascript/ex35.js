...
let vetorPilha1 = [1, 2, 3, 4, 5]
let vetorAdiciona1 = [6, 7, 8, 9, 10]

let juntandoArrays = vetorPilha1.concat(vetorAdiciona1)

console.log("Resultado da concatenação: " + juntandoArrays)
